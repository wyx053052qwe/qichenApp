...
class MobileController extends \Mobile\Controller\MobileController {
    ...
    public function _initialize()
    {
        ...
        $tpl_dir = str_replace("Mobile", "Jobfair", $tpl_dir);
    ...
    {
        $this->theme('mobile')->display('Jobfair@./index');die;
    }
    ...
    public function show()
    {
        ...
        $this->wx_share();
        $this->theme('mobile')->display('Jobfair@./show');die;
    }
    ...
    {
        $this->wx_share();
        $this->theme('mobile')->display('Jobfair@./comlist');die;
    }
    /**
     * 展位预定
    ...
    public function reserve(){
        ...
        $this->wx_share();
        $this->theme('mobile')->display('Jobfair@./reserve');die;
    }
    /**
     * 展位预定保存
     */
