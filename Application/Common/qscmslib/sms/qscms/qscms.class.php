...
class qscms_sms{
	...
	protected $_base_url = 'https://www.74cms.com/SMSsend.php?';//基础类短信请求地址
	protected $_notice_url = 'https://www.74cms.com/SMSsend.php?';//通知类短信请求地地址
	protected $_captcha_url = 'https://www.74cms.com/SMSsend.php?';//验证码类短信请求地址
	protected $_other_url = 'https://www.74cms.com/SMSsend.php?market=1&';//其它类短信请求地址
