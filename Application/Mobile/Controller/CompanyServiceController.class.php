...
class CompanyServiceController extends CompanyController{
    ...
    public function index(){
        ...
        if($config['qscms_m_template_dir'] == 'qichen'){
            $this->display('Company/service/index1');
        }else{
    ...
    public function setmeal_detail(){
        ...
        $config = D('Config')->config_cache();
        if($config['qscms_m_template_dir'] == 'qichen'){
            $this->display('Company/service/setmeal_detail1');
        }else{
    ...
    public function order_list(){
        ...
        $config = D('Config')->config_cache();
        if($config['qscms_m_template_dir'] == 'qichen'){
           $this->display('Company/service/order_list1');
        }else{
    ...
    public function order_detail($order_id){
        ...
        $config = D('Config')->config_cache();
        if($config['qscms_m_template_dir'] == 'qichen'){
            $this->display('Company/service/order_detail1');
        }else{
    ...
    public function setmeal_add(){
    	...
    	if(IS_POST){
            ...
            $config = D('Config')->config_cache();
            if($config['qscms_m_template_dir'] == 'qichen'){
                $this->display('Company/service/setmeal_add1');
            }else{
