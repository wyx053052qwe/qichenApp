...
class AdminController extends ConfigbaseController{
    ...
    public function page_edit(){
        if(IS_POST){
            ...
            $_POST['alias']=I('post.alias','','trim')?I('post.alias','','trim'):$this->returnMsg(0,'调用ID不能为空！');
            substr($_POST['alias'],0,3)=='QS_'?$this->returnMsg(0,'调用名称不允许 QS_ 开头！'):'';
            }
            ...
            {
                $this->returnMsg(0,"调用ID ".$_POST['alias']." 已经存在！请重新填写");
            }
        }
        parent::edit();
    }
