...
$(function() {
    ...
    $imSel.off().on('click', function() {
        ...
        $(this).closest('.imSelectParent').find('.imSelect').addClass('action-toggle');
    ...
    $imSel.closest('.imSelectParent').find('.imOption').off().on('click', function() {
        ...
        var $objParent = $(this).closest('.imSelectParent'),
            ...
            $objKeyS = $objParent.find('.selectKeyS'),
            $objTxt = $objParent.find('.selectTxt'),
            $cuSelect = $objParent.find('.imSelect'),
    ...
    function imSelHide() {
        $('.imSelMask').remove();
        $('.imSelect').removeClass('action-toggle');
        if ($('.imSelectSub').length) {
            $('.imSelectSub').removeClass('action-toggle');
        }
    }
});