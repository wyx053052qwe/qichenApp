...
<div class="mainli num">个人新增订单<a href="<?php echo U('personal/index_per');?>" id="yesterday_personal_order">&nbsp;</a></div>
...
<div class="toptit">启辰人才系统</div>
<div class="mainli">系统当前版本：v<?php echo C('QSCMS_VERSION');?><span id="update_notice"></span></div>
<div class="mainli link_blue">认证授权：<span id="certification">帮管家认证商业版</span></div>

<div class="mainli">程序开发：帮管家二次开发组</div>
