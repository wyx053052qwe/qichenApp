...
<div class="seltpye_y">
    ...
    <div class="downlist">
        ...
        <li url="<?php echo P(array('jobssettr'=>'30','settr_cn'=>'一月内'));?>">一月内</li>
    </div>
</div>
<div class="seltpye_y">
...
<div class="seltpye_y">
    ...
    <div class="ct">
        <div class="txt <?php if((Think.get.intention_jobs != '') AND (Think.get.intention_jobs != $cate['categoryname'])): ?>select<?php endif; ?>"><?php echo ((_I($_GET['intentionsettr_cn']) != "")?(_I($_GET['intentionsettr_cn'])):"不限"); ?></div>
    </div>
    <div class="downlist">
        <?php if(is_array($cate)): $i = 0; $__LIST__ = $cate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cate): $mod = ($i % 2 );++$i;?><li url="<?php echo P(array('intention_jobs'=>$cate['categoryname'],'intentionsettr_cn'=>$cate['categoryname']));?>"><?php echo ($cate['categoryname']); ?></li><?php endforeach; endif; else: echo "" ;endif; ?>
    </div>
</div>
<div class="clear"></div>
...
<form id="form1" name="form1" method="post" action="<?php echo U('set_audit');?>">
    ...
    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="list_tr link_black">
            ...
            <div class="td edit" style=" width:20%;">
                ...
                <?php if($apply['Analyze']): ?><a href="<?php echo U('Analyze/Admin/analyze_list_per',array('id'=>$vo['id'],'_k_v'=>$vo['id']));?>">统计</a><?php endif; ?>
